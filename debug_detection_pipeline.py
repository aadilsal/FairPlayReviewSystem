...
def process_frames_pipeline(
	...
	# For debug: store all ball detections for overlay
	all_ball_infos = []
	# Optionally, you could also keep a trajectory model if available
	...
	for frame_idx, frame_path in enumerate(frame_paths):
		...
		# Instead of visualize_frame, use draw_trajectory_overlay for debug
		vis_frame = draw_trajectory_overlay(
			frame.copy(),
			all_ball_infos,
